...
int main(int argc, char* argv[]) {
    ...
    backgroundTextures.push_back(loadTexture("./Assets/Pixel_Forest/layer12.png"));
    backgroundTextures.push_back(loadTexture("./Assets/Pixel_Forest/layer13.png"));
    backgroundTextures.push_back(loadTexture("./Assets/Pixel_Forest/layer14.png"));
